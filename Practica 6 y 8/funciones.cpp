...
FILE* funciones::abrirArchivo(const char *nombre, const char *modo) {
	FILE* archivo = fopen(nombre, modo);
	return archivo;
}

// CloseFile: Cierra un fichero. Recibe como parámetro el identificador del fichero a cerrar.
unsigned int funciones::cerrarArchivo(FILE *file) {
...
unsigned int funciones::leerArchivo(const int numeroCaracteres, FILE *archivo, void *buffer) {
...
unsigned int funciones::escribirArchivo(const int numeroCaracteres, FILE *archivo, const void *buffer) {
